...
import mockupImageSrc from "images/phone.png";
...
const Container = tw(ContainerBase)`bg-primary-600 -mx-8`
...
const Subheading = tw(SubheadingBase)`text-gray-800 mb-4 font-extrabold tracking-wider`
...
const Highlighted = tw.span`bg-primary-800 text-gray-100 px-4 transform rounded-md inline-block`;
export default ({
      ...
      <Content>
        <Row>
          <TextContainer>
            ...
            <Text>"People all over the India are happily using <Highlighted>Libero Health</Highlighted>"</Text>
            <LinksContainer>
              <Link href={link1Url}>
          ...
          <ImageContainer>
            <img src={imageSrc} alt="" tw="w-auto"/>
          </ImageContainer>
        </Row>
